const gamesArr = [
    ...
    controls: [`←/→ Arrow Keys: Move horizontally`]
        ...
        },
        {
          ...
          controls: [
            `W/E (P1): Jump left/right`,
            `R (P1): Power up`,
            `I/O (P2): Jump left/right`,
            `P (P2): Power up`,
          ],
        },
        {
    ...
    - If pressing enter causes the game to tab in and out, just click on the middle of the game to refocus.`,
        ...
        },
        {
          ...
          controls: [
            `WASD/Arrow Keys: Control movement`,
            `Z/T: Shoot`,
            `X/Y: Throw bomb`,
          ],
        },
    ...
    The game also includes a console to mess around with after finishing the game, or just being frustrated by thinking with portals!`,
          controls: [
            `WAD: Control movement`,
            `Q: Open a blue portal`,
            `E: Open a yellow portal`,
            `R: Close portals`,
            `F: Pick up object`,
            `Esc/P: Pause game`,
          ],
